...
const World = dynamic(() => import("./Globe").then((m) => m.World), {
  ssr: false,
  loading: () => (
    <div className="w-full h-full animate-pulse rounded-full bg-slate-800/40" />
  ),
});
      ...
      >
        ...
        <div className="absolute w-full h-72 md:h-full z-10">
          {inView ? (
            ...
            <div className="w-full h-full animate-pulse rounded-full bg-slate-800/30" />
          )}
        </div>
      </div>
    </div>
